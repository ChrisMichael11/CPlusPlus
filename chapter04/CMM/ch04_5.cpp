//  Write function that reads words from input stream and stores in a vector.  Use that 
//  function to both write programs that count the number of words in the input and to 
